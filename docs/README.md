...
| [progress.md](./progress.md) | **完成度报告** | 全员 | Phase/API/测试/缺口审计 |
...
1. [progress.md](./progress.md) — 当前能演示什么、缺什么
2. [interview-talking-points.md](./interview-talking-points.md)
3. [eval-benchmark.md](./eval-benchmark.md)
4. [deployment.md](./deployment.md) § Demo 检查清单

## 文档维护约定

- **版本号：** 与 [项目设计](./项目设计.md) 对齐（当前 `v0.2-progress`）
...
| 日期 | 说明 |
|------|------|
| 2026-06-14 | 完成度审计；新增 progress.md；更新 P1 backlog 与项目设计成功标准 |
